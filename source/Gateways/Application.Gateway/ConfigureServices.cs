...
using Application.Gateway.Helpers;
...
public static class ConfigureServices
{
    ...
    static string[] ProductApplicationDomains = ["https://marketasssitant.tricksfor.com"];
    static string[] StagingApplicationDomains = ["https://marketasssitant-staging.tricksfor.com", "https://marketasssitant-staging.tricksfor.com"];
    ...
    public static IServiceCollection AddServices(this IServiceCollection services, WebApplicationBuilder builder)
    {
        ...
        services.AddSingleton<IServiceDiscoveryProviderFactory, AspireServiceDiscoveryProviderFactory>();

        // Will not be called, but it is required for internal validators, aka life hack
        services.AddSingleton<ServiceDiscoveryFinderDelegate>((serviceProvider, config, downstreamRoute)
            => null);
