...
public class BetInitiatedDto
{
    public BetInitiatedDto(string game, long matchId, Guid id, decimal value, long externalTokenId, string transactionHash, DateTime dateTime, OptionDto option)
    {
        this.game = game;
