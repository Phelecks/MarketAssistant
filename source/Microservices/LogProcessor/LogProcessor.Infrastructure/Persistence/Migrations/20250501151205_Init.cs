            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Chain = table.Column<int>(type: "int", nullable: false),
                    ContractAddress = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    StakeContractAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OwnerWalletAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RoyaltyWalletAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
