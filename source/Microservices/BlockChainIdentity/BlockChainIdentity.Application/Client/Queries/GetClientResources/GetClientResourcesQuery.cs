...
public class Handler(IApplicationDbContext context, IMapper mapper) : IRequestHandler<GetClientResourcesQuery, PaginatedList<ResourceDto>>
{
    private readonly IApplicationDbContext _context = context;
    private readonly IMapper _mapper = mapper;

    public async Task<PaginatedList<ResourceDto>> HandleAsync(GetClientResourcesQuery request, CancellationToken cancellationToken)
    {
